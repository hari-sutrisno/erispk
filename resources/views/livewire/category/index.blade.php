        ...
        <div class="max-w-full overflow-x-auto p-4">
            ...
            <div
                ...
                <table class="min-w-full text-sm">
                    <thead class="bg-gray-100 dark:bg-white/[0.04]">
                        <tr>
                            ...
                            <th class="px-4 py-2 cursor-pointer text-start text-theme-xs font-medium text-gray-500 dark:text-gray-400"
                                wire:click="sortBy('tblm_kategori.keterangan')">
                                Keterangan {!! $this->sortField === 'tblm_kategori.keterangan'
                                    ? ($this->sortDirection === 'asc'
                                        ? ' &#129057;'
                                        : ' &#129059;')
                                    : '' !!}
               ...
               {{ $category->status ? 'bg-success-500' : 'bg-error-500' }}">
                                    ...
                                    <td class="px-4 py-2 text-end space-x-2">
                                        ...
                                        @can('category delete')
                                            <x-tooltip content="Delete" position="top">
                                                <button type="button"
                                                    x-on:click="$dispatch('confirm-delete', { id: {{ $category->id }} })"
                ...
                {{-- Pagination --}}
                @if ($this->ready && method_exists($categories, 'links'))
